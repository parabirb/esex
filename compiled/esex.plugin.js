 ...
 * @name esex
 * @author parabirb
 * @description esex: enabling secure encryption x, an actually functional end-to-end encryption plugin for discord
 * @version 0.0.1
 */
(function (nacl) {
    'use strict';
...
// See for details: http://tweetnacl.cr.yp.to/
    // modified by parabirb to work w betterdiscord
...
(function(root, f) {
    'use strict';
    // we don't want this shit to break now, do we?
    root.nacl.auth = f(root.nacl);

}(window, function(nacl) {
    'use strict';
 ...
 * modified by parabirb to work with discord
 */
/* jshint newcap: false */
(function(root, f) {
    'use strict';
